...
/* https://github.com/pololu/vl6180x-arduino port for STM32 */
...
extern void 		VL6180X_SetAddress(uint8_t new_addr);
extern void 		VL6180X_Init(void);
extern void 		VL6180X_ConfigureDefault(void);

extern void 		VL6180X_WriteReg(uint16_t reg, uint8_t value);
extern void 		VL6180X_WriteReg16Bit(uint16_t reg, uint16_t value);
extern void 		VL6180X_WriteReg32Bit(uint16_t reg, uint32_t value);

extern uint8_t 		VL6180X_ReadReg(uint16_t reg);
extern uint16_t 	VL6180X_ReadReg16Bit(uint16_t reg);
extern uint32_t 	VL6180X_ReadReg32Bit(uint16_t reg);

extern void 		VL6180X_SetScaling(uint8_t new_scaling);
extern uint8_t 		VL6180X_GetScaling(void);

extern uint8_t 		VL6180X_ReadRangeSingle(void);
extern uint16_t 	VL6180X_ReadRangeSingleMillimeters(void);
extern uint16_t 	VL6180X_ReadAmbientSingle(void);

extern void 		VL6180X_StartRangeContinuous(uint16_t period);
extern void 		VL6180X_StartAmbientContinuous(uint16_t period);
extern void 		VL6180X_StartInterleavedContinuous(uint16_t period);
extern void 		VL6180X_StopContinuous();

extern uint8_t 		VL6180X_ReadRangeContinuous(void);
extern uint16_t 	VL6180X_ReadRangeContinuousMillimeters(void);
extern uint16_t 	VL6180X_ReadAmbientContinuous(void);

extern void 		VL6180X_SetTimeout(uint16_t timeout);
extern uint16_t 	VL6180X_GetTimeout(void);
extern uint8_t 		VL6180X_TimeoutOccurred(void);

#define 			VL6180X_Constrain(amt,low,high) ((amt)<(low)?(low):((amt)>(high)?(high):(amt)))
