...
#include "sool/Effectors/TB6600_stepper_driver/StepperTB6600.h"
#include "sool/Peripherals/USART/USART.h" // debugging purposes - DEPRECATED
...
//void StepperTB6600_Init	(uint16_t dir_pin, GPIO_TypeDef* dir_port, uint16_t en_pin, GPIO_TypeDef* en_port, uint16_t pul_pin, GPIO_TypeDef* pul_port) {
